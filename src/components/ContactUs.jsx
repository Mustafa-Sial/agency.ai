...
const ContactUs = () => {
    ...
    formData.append("access_key", "a3ccd90e-3a90-418e-a27a-0c3a99da9b82");
  ...
  return (
    ...
    id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 placeholder-teal-300 text-gray-700 dark:text-white pt-30'>
